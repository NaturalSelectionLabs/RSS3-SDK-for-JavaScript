...
type RSS3Content = RSS3UserContent | RSS3NodeContent;
type RSS3UserContent = RSS3Index | RSS3SignedList;
type RSS3NodeContent = RSS3UnsignedList;
...
type RSS3List = RSS3SignedList | RSS3UnsignedList;

// RSS3List file, used for list of links, backlinks, contexts, items
interface RSS3ListBase extends RSS3Base {
    id: RSS3ListID;

    list?: RSS3ID[] | RSS3ItemID[] | RSS3Asset[] | RSS3Item[];
    list_next?: RSS3ListID;
}

interface RSS3SignedList extends RSS3ListBase {
    signature: string;
    agent_id?: string;
    agent_signature?: string;
}

interface RSS3UnsignedList extends RSS3ListBase {
    auto: true;
}

interface RSS3ItemsList extends RSS3SignedList {
    id: RSS3ItemsListID;
    list?: RSS3Item[];
    list_next?: RSS3ItemsListID;
}

interface RSS3LinksList extends RSS3SignedList {
    id: RSS3LinksListID;
    list?: RSS3ID[];
    list_next?: RSS3LinksListID;
}

interface RSS3BacklinksList extends RSS3UnsignedList {
    id: RSS3BacklinksListID;
    list?: RSS3ID[];
    list_next?: RSS3BacklinksListID;
}

interface RSS3AssetsList extends RSS3UnsignedList {
    id: RSS3AssetsListID;
    list?: RSS3Asset[];
    list_next?: RSS3AssetsListID;
}

interface RSS3ItemBacklinksList extends RSS3UnsignedList {
